...
public class Lecture {
    ...
    */
    public int[] returnArray() {  // int[] as the return data type means are returning an array
        int[] array = { 80, 8080, 443 };
        // above declares and initializes in one step
        // int[] array = new int[3];
        // array[0] = 80;
        //  array[1] = 8080;
        // array [2] = 443;
    ...
    */
    public int returnFirstElement() {
        ...
        return portNumbers[0];  // first element is index 0 so that's what we returns
    }
    ...
    */
    public int returnLastElement() {
        ...
        // return portNumbers[portNumbers.length - 1];  .length property how many elements in array
    }
    ...
    */
    public int returnLastElementOfParam(int[] passedInArray) {
        ...
        return passedInArray[passedInArray.length - 1];  // .length - 1 gives us the index of last element
    }
...
//            int result = number * 5;
    ...
    */
    public boolean returnSumEveryOtherNumber() {
        ...
        for (int i = 0; i < arrayToLoopThrough.length; i += 2) {  //i = i + 2
